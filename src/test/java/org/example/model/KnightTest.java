...
public class KnightTest {
    ...
    public void setup(){
        ...
        knight = new Knight(1, board.getSquareArray()[2][2], RESOURCES_WQUEEN_PNG);
        board.getSquareArray()[2][2].put(knight);
    ...
    public void TestLegalMoves(){
        ...
        List<Square> squares = List.of(
                board.getSquareArray()[4][1],
                board.getSquareArray()[4][3],
                board.getSquareArray()[0][1],
                board.getSquareArray()[0][3],
                board.getSquareArray()[1][4],
                board.getSquareArray()[3][4],
                board.getSquareArray()[1][0],
                board.getSquareArray()[3][0]
        );
