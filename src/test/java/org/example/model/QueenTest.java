...
public class QueenTest {
    ...
    public void setup(){
        ...
        queen = new Queen(1, board.getSquareArray()[2][2], RESOURCES_WQUEEN_PNG);
        board.getSquareArray()[2][2].put(queen);
    ...
    public void testLegalMoves(){
        ...
        List<Square> squares = List.of(
                ...
                board.getSquareArray()[2][0],
                board.getSquareArray()[2][1],
                board.getSquareArray()[2][3],
                board.getSquareArray()[2][4],
                board.getSquareArray()[2][5],
                board.getSquareArray()[2][6],
                board.getSquareArray()[2][7],
                board.getSquareArray()[7][2],
                board.getSquareArray()[6][2],
                board.getSquareArray()[5][2],
                board.getSquareArray()[4][2],
                board.getSquareArray()[3][2],
                board.getSquareArray()[1][2],
                board.getSquareArray()[0][2],
